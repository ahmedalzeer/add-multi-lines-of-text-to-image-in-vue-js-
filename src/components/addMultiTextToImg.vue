<template>
    <div class="editor-container">
        ...
        <div class="left-panel">
                ...
                <div class="setting-group form-group">
                    <div class="setting-group row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <i @click="removeTextLine(index)" class="fa fa-trash" style="color:#db7878; font-size: 17px; cursor: pointer;"></i>
                            <i @click="toggleTextLineVisibility(index)" class="fa" :class="{ 'fa-minus-circle': textLine.visible, 'fa-plus-circle': !textLine.visible }" style="color:#9797ee; font-size: 19px; cursor: pointer;"></i>
                        </div>
                    </div>
                </div>
            ...
            <div>
                <i @click="addTextLine" class="fa fa-plus-circle" style="color:#82ce82; font-size: 24px; cursor: pointer;"></i>
            </div>
        </div>
